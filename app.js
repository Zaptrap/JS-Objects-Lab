...
//  Exercise 1 - explore Pokemon Array

console.dir(pokemon, { maxArrayLength: null });

//  Exercise 2 - explore game object

console.log(game)

//  Exercise 3 - update agme object
...
*/
// game.push(difficulty = [easy, medium, hard]);

game.difficulty = "medium";
console.log(game.difficulty);

//  Exercise  4 - add from the pokemon array into the game
...
*/
const Vulpix = pokemon[36];
const Abra = pokemon[62];
const Lapras = pokemon[130];

console.log(game);
game.party.push(Vulpix, Abra, Lapras);
console.log(game);
